...
export const KEYWORDS: Map<string, TokenType> = new Map([
  ...
  ['pub',        TokenType.PUB],
  ['public',     TokenType.PUB],
  ['publico',    TokenType.PUB],
  ['priv',       TokenType.PRIV],
  ['private',    TokenType.PRIV],
  ['privado',    TokenType.PRIV],
  ['prot',       TokenType.PROT],
  ['protected',  TokenType.PROT],
  ['protegido',  TokenType.PROT],
  ['published',  TokenType.PUBLISHED],
  ['publicado',  TokenType.PUBLISHED],
  ['procedure',  TokenType.FN],
  ['procedimento', TokenType.FN],
